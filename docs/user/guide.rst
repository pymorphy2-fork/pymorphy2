...
Чтобы установить оптимизированную версию, используйте следующую команду::
...
Также можно получить набор всех граммем в виде множества::

    >>> p.tag.grammemes
    frozenset({'past', 'VERB', 'perf', 'plur', 'intr', 'indc'})
